...
import { formatWithSuffix, formatMultiplier, getCurrencySymbol, handleImageError } from '@shared/lib';
              ...
              <div className={styles.info}>
                <div className={styles.image}>
                  {isLoading ? (
                    ...
                    <img src={item?.avatar_url || anonAvatar} alt={item?.user_name || ''} onError={handleImageError} />
                  )}
                </div>
                {isLoading ? (
                  <>
                  ...
                  <>
                    ...
                    <p className={styles.amount}>
                      {item ? `${formatWithSuffix(item.payout)} ${getCurrencySymbol(item.currency)}` : '—'}
                    </p>
