...
import {TableBody, TableCell, TableHead, TableHeader, TableRow} from "@shared/ui/table/Table.tsx";
import {TABLE_DATA} from './mockTable.tsx'
    ...
    return (
        <div className={styles.transactionHistory}>
            ...
            <Table>
                ...
                <TableBody>
                    {TABLE_DATA.map(item => {
                        const statusClassName = item.status === 'Успешно'
                        ...
                        return (
                            <TableRow key={item.id}>
                                ...
                                <TableCell
                                    className={`${statusClassName} ${styles.td}`}>{item.status}</TableCell>
                            </TableRow>
                        )
                    })}
                </TableBody>
