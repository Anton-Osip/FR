import { FC, type ReactElement, type RefObject, useMemo, useState } from 'react';
...
const FIRST_SLIDE = 1;
const SLIDE_INDICES = [FIRST_SLIDE];
...
export const LoginModal: FC<LoginModalProps> = ({ onRecoverPassword, swipeCloseElementRef }) => {
  ...
  return (
    <>
      <div className={styles.slider} ref={swipeCloseElementRef}>
        <Swiper
          modules={[Autoplay]}
          loop={true}
          speed={800}
