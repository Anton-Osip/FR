        ...
        return executeApiRequest<WalletDepositMethodsResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/deposit/methods`,
            method: 'GET',
          },
        ...
        return executeApiRequest<WalletDepositActiveResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/deposit/active${queryString}`,
            method: 'GET',
            logData: {
        ...
        return executeApiRequest<WalletWithdrawMethodsResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/withdraw/methods`,
            method: 'GET',
          },
          baseQuery as BaseQueryFn,
        );
        ...
        return executeApiRequest<WalletWithdrawBanksResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/withdraw/banks?method=${encodeURIComponent(
              params.method,
        ...
        return executeApiRequest<WalletPhoneCountriesResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/phone/countries${queryString}`,
            method: 'GET',
            logData: {
              q: params.q,
              limit: params.limit,
        ...
        return executeApiRequest<WalletWithdrawEligibilityResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/withdraw/eligibility${queryString}`,
            method: 'GET',
            logData: {
              payment_method: params.method,
              amount: params.amount,
        ...
        return executeApiRequest<WalletDepositResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/deposit`,
            method: 'POST',
            body: params,
            headers: {
        ...
        return executeApiRequest<WalletWithdrawResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/withdraw`,
            method: 'POST',
            body: params,
            headers: {
              'content-type': 'application/json',
        ...
        return executeApiRequest<WalletTransactionsResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/transactions${queryString}`,
            method: 'GET',
          },
          baseQuery as BaseQueryFn,
        );
        ...
        return executeApiRequest<WalletTransaction>(
          {
            ...
            url: `${getBFF()}/api/v1/wallet/transactions/${params.uuid}`,
            method: 'GET',
            logData: {
              uuid: params.uuid,
            },
