...
import { getBFF, SOCKET_PATHS, SOCKET_EVENTS } from '@/shared/config';
        ...
        return executeApiRequest<ShowcaseGamesResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/games${queryString}`,
            method: 'GET',
            logData: {
              hasParams: !!params,
        ...
        return executeApiRequest<GetShowcaseProvidersResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/providers`,
            method: 'GET',
          },
          baseQuery as BaseQueryFn,
        );
        ...
        return executeApiRequest<BettingTableBetsLatestResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/betting_table/bets/latest${queryString}`,
            method: 'GET',
            logData: {
              hasParams: !!params,
              pageSize: params?.page_size,
        ...
        return executeApiRequest<BettingTableBetsLatestResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/betting_table/bets/my${queryString}`,
            method: 'GET',
            logData: {
              hasParams: !!params,
              pageSize: params?.page_size,
        ...
        return executeApiRequest<BettingTableBetsLatestResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/betting_table/bets/big-wins${queryString}`,
            method: 'GET',
            logData: {
              hasParams: !!params,
              pageSize: params?.page_size,
        ...
        return executeApiRequest<GetSlotInfoResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/info?game_uuid=${params.game_uuid}`,
            method: 'GET',
        ...
        return executeApiRequest<GetSlotLeaderboardBigWinsResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/leaderboards/big-wins?game_uuid=${params.game_uuid}&top_n=${topN}`,
            method: 'GET',
        ...
        return executeApiRequest<GetSlotLeaderboardLuckyResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/leaderboards/lucky?game_uuid=${params.game_uuid}&top_n=${topN}`,
            method: 'GET',
            logData: { game_uuid: params.game_uuid, top_n: topN },
          },
          baseQuery as BaseQueryFn,
        ...
        return executeApiRequest<GetSlotLeaderboardTodayBestResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/leaderboards/today-best?game_uuid=${params.game_uuid}&top_n=${topN}`,
            method: 'GET',
            logData: { game_uuid: params.game_uuid, top_n: topN },
          },
          baseQuery as BaseQueryFn,
        ...
        return executeApiRequest<GetFeaturedSlotResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/featured-slot/${params.kind}`,
            method: 'GET',
        ...
        return executeApiRequest<InitSlotResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/init`,
            method: 'POST',
            body: params,
            headers: {
        ...
        return executeApiRequest<InitSlotDemoResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/init/demo`,
            method: 'POST',
            body: params,
            headers: {
              'content-type': 'application/json',
        ...
        return executeApiRequest<AddFavoriteResponse>(
          {
            ...
            url: `${getBFF()}/api/v1/showcase/slot/favorites`,
            method: 'POST',
            body: params,
            headers: {
              'content-type': 'application/json',
