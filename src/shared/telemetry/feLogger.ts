...
const MAX_BATCH = Number(import.meta.env.VITE_FE_LOG_MAX_BATCH ?? 50);
const FLUSH_MS = Number(import.meta.env.VITE_FE_LOG_FLUSH_MS ?? 250);
...
function push(level: Level, msg: string, ctx?: Ctx) {
