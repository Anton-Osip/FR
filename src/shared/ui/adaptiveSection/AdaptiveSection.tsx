...
export const AdaptiveSection = <T,>({
  ...
  const renderSlider = (): ReactElement => (
    <div key={sliderKey} className={clsx(styles.carousel, sliderClassName)}>
      ...
      <div className={clsx(styles.shadow, styles.shadowLeft, canScrollPrev && styles.shadowVisible)} />
      <div className={clsx(styles.shadow, styles.shadowRight, canScrollNext && styles.shadowVisible)} />
      <Swiper
